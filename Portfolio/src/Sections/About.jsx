...
const About = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setProjects((prev) => (prev < 15 ? prev + 1 : 15)); // 10 + 5 freelancing
    ...
    <div id="about">
      <section className="min-h-screen flex flex-col md:flex-row items-center bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-gray-200 px-6 py-12">
        ...
        <div className="md:w-1/2 text-center md:text-left" data-aos="fade-right">
          ...
          <p className="text-lg md:text-xl font-medium leading-relaxed text-gray-300 mb-4">
            I am a <span className="text-[#38bdf8]">B.Tech Computer Science</span> student at{" "}
            <span className="text-[#ffcc00]">Prestige Institute of Management and Research, Bhopal</span>, passionate about software development and solving complex problems.
          </p>

          <p className="text-lg md:text-xl font-medium leading-relaxed text-gray-300 mb-4">
            As a <span className="text-[#38bdf8]">MERN Stack Developer</span>, I love building scalable and modern web applications.
          </p>

          <p className="text-lg md:text-xl font-medium leading-relaxed text-gray-300 mb-4">
            I’ve also worked on <span className="text-[#ffcc00]">5+ freelancing projects</span> for real clients, helping businesses build their online presence with custom websites and apps.
          </p>

          <p className="text-lg md:text-xl font-medium leading-relaxed text-gray-300 mb-4">
            Beyond development, I enjoy <span className="text-[#38bdf8]">Data Structures & Algorithms</span> and have a strong curiosity about <span className="text-[#ffcc00]">Cybersecurity</span>.
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center sm:space-x-12 space-y-4 sm:space-y-0 justify-center md:justify-start" data-aos="fade-up">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-400">Projects (Including Freelance)</p>
            </div>
            <div className="text-center">
